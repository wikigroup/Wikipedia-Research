...
def addToDB(pageID, pageText, cursor):
    cursor.execute("INSERT INTO articleText VALUES (%s, %s);", (pageID, pageText))
...
if __name__=="__main__":
	...
	p = multiprocessing.Process(target=qManager,args=(outQ,connection,))
	p.start()
